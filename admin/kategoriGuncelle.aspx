...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="height: 28px; color: #23282d; font-weight: 400; font-size: 23px;">Kategori Güncelle</div>
    ...
    <table class="auto-style1">
        ...
        <tr>
            <td>
                <asp:Button ID="Button1" runat="server" CssClass="btnGorsel" Height="43px" Text="Kategori Güncelle" Width="177px" OnClick="Button1_Click" />
            </td>
        </tr>
